...
public class B30ComparatorTest {
    ...
    public static void main(String[] args) {
        // 객체는 여러 필드로 구성된 데이터이다. 비교(정렬)할때 기준값이 필요함
        // 그 기준값을 전달하는 방법이 Comparable, Comparator 인터페이스 사용이다.
   ...
   //Comparator 인터페이스 활용한 Arrays.sort 실행하기
    ...
    // Arrays.sort(members, Comparator 를 구현한 클래스 객체)
        ...
        // 나이 필드값 정렬 - 인터페이스의 익명 클래스로 만들어 본다.
        // 비교자
        ...
        System.out.println(" // Comparator 구현체 생성 람다식 // ");
