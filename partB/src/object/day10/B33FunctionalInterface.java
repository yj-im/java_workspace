...
public class B33FunctionalInterface {
    ...
    public static void main(String[] args) {
        ...
        //      ㄴ 리턴과 인자가 둘다 없는 추상메소드를 run()을 갖는다.
        ...
        //          ㄴ T는 인자의 타입 설정. void accept(T t) 추상 메소드를 갖는다.
        Consumer<String> consumer =(message)-> System.out.println("메세지 = "+message);     // return 생략가능
        ...
        Function<Double, Double> function=(d)->Math.pow(2, d);  // return 생략가능
        // Math.pow(a,b) 는 a의 b승 구한다. 
        // 실행
        ...
        members.forEach((item) -> System.out.println("*"+item+"*"));    // 인자를 받아서 출력하는 추상메소드 구현
    }
}
