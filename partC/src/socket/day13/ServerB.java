...
public class ServerB {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ////////////// 연결 요청이 오면 승인을 한다. //////////////
            /// accept 로 데이터 송수신에 사용할 일반 Socket 이 만들어 진다.
        ...
        // 서버는 인터넷(입력)에서 파일을 받아 서버 컴퓨터(출력)로 저장.
         ...
         BufferedOutputStream bos=new BufferedOutputStream(new FileOutputStream(filepath)); // 서버 컴퓨터
        int b; int count=0;
         while ((b=bis.read())!=-1) {
            bos.write(b);
            count++;
         }
         System.out.println("바이트 파일이 저장되었습니다.");
