...
public class ClientB {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /////// 서버에게 연결 요청 ///////
            ///  연결하려는 서버의 ip, port 를 정확히 설정하여 연결 요청을 보낸다.
            // socket.connect(new InetSocketAddress("localhost",5050));
            socket.connect(new InetSocketAddress("192.168.0.132",5050));
            ...
            // 클라이언트 컴퓨터(입력)의 이미지 파일을 인터넷(출력)을 통해 서버로 업로드
        ...
        System.out.println(count+"바이트 파일을 업로드 완료 했습니다.");
